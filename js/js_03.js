...
function bg_1(event) {
    console.log( $section);
    $section.style.background="url(img/bg-m.gif)no-repeat center center fixed/cover";
...
function bg_2(event) {
    console.log( $section);
    $section.style.background="url(img/04-min.gif)no-repeat center center fixed/cover";
...
function bg_3(event) {
    console.log( $section);
    $section.style.background="url(img/03-min.gif)no-repeat center center fixed/cover";
...
function bg_4(event) {
    console.log( $section);
    $section.style.background="url(img/05-min.gif)no-repeat center center fixed/cover";
...
function bg_5(event) {
    console.log( $section);
    $section.style.background="url(img/06.gif)no-repeat center center fixed/cover";
